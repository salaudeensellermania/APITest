...
#Purpose: To do a regression check for GetInventory Call (to see if the call is success, all the data are properly fetched from DB, and also the tags and data are validated)
...
#OOPS		
		obj1=xml_inventory_parse.getinventory()
#call1
		r=obj1.getinventorystatuscode()
...
#Get Status code and print the results
	...
	#call2
				...
				if i==0:
					...
					outfile.write("\n")
					print ("-------------------------------------------")
					outfile.write("INVENTORY API - GET INVENTORY --> PASSED")
					outfile.write("\n")
					print ("INVENTORY API - GET INVENTORY --> PASSED")
					outfile.write("-------------------------------------------")
					print ("-------------------------------------------")
					outfile.write("\n")
					print ("\n")
					...
					outfile.write("\n")
					print ("---------------------------------------------------------------------------")
					outfile.write("INVENTORY API - GET INVENTORY --> PASSED WITH ERROR / DATA MISMATCH")
					outfile.write("\n")
					print ("INVENTORY API - GET INVENTORY --> PASSED WITH ERROR / DATA MISMATCH")
					outfile.write("---------------------------------------------------------------------------")
					print ("---------------------------------------------------------------------------")
					outfile.write("\n")
					print ("\n")
	...
	#call3
				...
				outfile.write("\n")
				print ("-------------------------------------------")
				outfile.write("INVENTORY API - GET INVENTORY --> FAILED")
				outfile.write("\n")
				print ("INVENTORY API - GET INVENTORY --> FAILED")
				outfile.write("-------------------------------------------")
				print ("-------------------------------------------")
				outfile.write("\n")
				print ("\n")
