...
#OOPS		
		obj1=xml_order_parse.getorderbydate()
#call1
...
#Get Status code and print the results
	...
	#			print i
				...
				if i==0:
					...
					outfile.write("\n")
					print ("-------------------------------------------")
					outfile.write("ORDER API - GetOrderByDate --> PASSED")
					outfile.write("\n")
					print ("ORDER API - GetOrderByDate --> PASSED")
					outfile.write("-------------------------------------------")
					print ("-------------------------------------------")
					outfile.write("\n")
					print ("\n")
					...
					outfile.write("\n")
					print ("---------------------------------------------------------------------------")
					outfile.write("ORDER API - GetOrderByDate --> PASSED WITH ERROR / DATA MISMATCH")
					outfile.write("\n")
					print ("ORDER API - GetOrderByDate --> PASSED WITH ERROR / DATA MISMATCH")
					outfile.write("---------------------------------------------------------------------------")
					print ("---------------------------------------------------------------------------")
					outfile.write("\n")
					print ("\n")
	...
	#call3
				...
				outfile.write("\n")
				print ("-------------------------------------------")
				outfile.write("ORDER API - GetOrderByDate --> FAILED")
				outfile.write("\n")
				print ("ORDER API - GetOrderByDate --> FAILED")
				outfile.write("-------------------------------------------")
				print ("-------------------------------------------")
				outfile.write("\n")
				print ("\n")
